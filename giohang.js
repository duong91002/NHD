...
function innerTongTien(Username){
    ...
    document.getElementById('Bottom_GH').innerHTML='<div id="backsp" onclick="dislayer_GH()" style="float: right;">BACK</div><div style="float: left;">Tổng Giá:</div><div style="float: left;" id="TongGia_GH">'+tongTien+'$</div><input style="float: left;" type="button" onclick="xuatDonHang()" value="Thanh Toán">'
...
function xoaGioHang(tentaikhoan){
    ...
    document.getElementById('Bottom_GH').innerHTML='<div id="backsp" onclick="dislayer_GH()" style="float: right;">BACK</div><div style="float: left;">Tổng Giá:</div><div style="float: left;" id="TongGia_GH">'+0+'$</div><input style="float: left;" type="button" onclick="xuatDonHang()" value="Thanh Toán">'
}
...
function showDH(){
    ...
    document.getElementById('Bottom_GH').innerHTML='<div id="backsp" onclick="dislayer_GH()" style="float: right;">BACK</div><div style="float: left" id="TongGia_GH">Cảm ơn quý khách</div>'
}